                       ...
                       const char *script)
{
    ...
    if ((pid = fork()) == 0)
    {
        // 2: open the script if present, but default to stdin
        FILE *infile;
        if (script != NULL)
        {
        ...
        // 3: set up a new connection to the server
        int sock;
        ...
        // 4: loop, sending queries and printing responses
...
int main(int argc, const char *argv[])
{
    ...
    // 1: create clients, they'll do the rest
